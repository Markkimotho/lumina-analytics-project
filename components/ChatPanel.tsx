...
export const ChatPanel: React.FC<ChatPanelProps> = ({ dataset, charts, onAddChart }) => {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-slate-900 border-l border-slate-800 md:border-l md:border-slate-800">
      <div className="p-3 md:p-4 border-b border-slate-800 bg-slate-900/50 backdrop-blur text-slate-200 font-semibold flex items-center gap-2 shrink-0">
